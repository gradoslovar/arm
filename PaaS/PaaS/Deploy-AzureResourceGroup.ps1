...
$resourceDeploymentName = 'IaaS-deployment'
$templatePath = "C:\Users\Nenad\Desktop\azure-resource-manager-deep-dive\3-azure-resource-manager-deep-dive-m3-exercise-files\IaaS\IaaS"
...
### 2 ### This is what I got from VS ARM template
